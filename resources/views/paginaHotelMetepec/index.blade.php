				...
				<div class="col-xxl-6 col-xl-7 col-lg-8">
					<div class="video__area-title" style="text-align: center;">
						...
						<h2>NUESTRAS HABITACIONES</h2>
							<!-- Nuestras habitaciones ofrecen una experiencia de confort y descanso, con un diseño moderno y elegante. Contamos con habitaciones individuales, dobles y suites</h2> -->
					</div>
				</div>
				<div class="col-xxl-6 col-xl-5 col-lg-4">
					<div class="video__area-right" style="color:#FFFFFF">
						<div class="video__play">
							Nuestras habitaciones ofrecen una experiencia de confort y descanso, con un diseño moderno y elegante. Contamos con habitaciones individuales, dobles y suites
							<!-- <a class="video-popup" href="https://www.youtube.com/watch?v=0WC-tD-njcA"><i class="fas fa-play"></i></a> -->
						</div>
					</div>
				</div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-6 lg-mb-30">
                        <div class="accommodations__area-title">
                            ...
                            <a class="theme-btn" href="nosotros.html">Leer mas<i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
				...
				<div class="col-xl-6 col-lg-6">
					<div class="feature__area-left">
						<div class="feature__area-left-title">
							...
							<p>Breve descripcion sdfks sdfsidof sdfjsuidf jsdfusd jsdfhns uisbnfij</p>
							<a class="theme-border-btn" href="services-details.html">Leer mas<i class="fal fa-long-arrow-right"></i></a>
						</div>
					</div>
				</div>
			</div>
