...
<div class="footer__area">
	<div class="container-fluid">
		<div class="row">
			<div class="col-xl-2 col-lg-1 col-md-4 col-12 mt-3">
				<div class="footer__area-widget">
					<div class="footer__area-widget-about my-3 d-flex align-items-center flex-sm-column flex-md-row">
			...
			<div class="col-xl-7 col-lg-4 col-md-4 col-12 my-3">
				<div class="footer__area-widget">
